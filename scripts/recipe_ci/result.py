#!/usr/bin/env python3
"""Immutable Recipe CI outcomes and small JSON serialization helpers."""
...
RESULT_SCHEMA_VERSION = "recipe-ci-result/v2"
NODE_RESULT_SCHEMA_VERSION = "recipe-ci-node-result/v2"
STOP_SIGNAL_SCHEMA_VERSION = "recipe-ci-stop-signal/v1"
