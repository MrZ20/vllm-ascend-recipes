...
"""
    ...
    def test_cache_key_includes_every_runtime_input(self) -> None:
        ...
        self.assertNotIn("MULTI_NODE_AISBENCH_ROOT", output)
    ...
    def test_package_install_is_pinned_and_does_not_clone(self) -> None:
        text = INSTALLER.read_text(encoding="utf-8")
        ...
        self.assertNotIn("AIS_BENCH_URL", text)
        self.assertNotIn("AIS_BENCH_EXPECTED_COMMIT", text)
